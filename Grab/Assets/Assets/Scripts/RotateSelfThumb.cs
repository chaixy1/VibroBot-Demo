...
public class RotateSelfThumb : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        ////尝试将接收到的字符串转换为浮点数
        //if (float.TryParse(UDPManager.latestRecvStr[], out float newZAngle))
        //{
        //    // 以初始旋转为基础，应用新的旋转角度
        //    Vector3 rotationVector = initialRotation + new Vector3(0, 0, -newZAngle);
        //    myObject.localEulerAngles = rotationVector;
        //}
        ...
        {
            // 以初始旋转为基础，创建目标旋转向量
            Vector3 targetRotationVector = initialRotation + new Vector3(newZAngle,0,0);
